...
router.get('/edit', function(req, res, next) {
  ...
  apiConnector.then(function(apiObject) {
    ...
    apiObject.bcApi.brands.agents.get(apiParams, {}, function(err, response) {
      ...
      console.log(util.inspect(agent, {showHidden: false, depth: null}));

      if (agent.businessMessagesAgent.conversationalSettings.en.privacyPolicy === undefined) {
        agent.businessMessagesAgent.conversationalSettings.en.privacyPolicy = {url: ''};
      }

      if (agent.businessMessagesAgent.conversationalSettings.en.offlineMessage === undefined) {
        agent.businessMessagesAgent.conversationalSettings.en.offlineMessage = {text: ''};
      }
...
router.post('/save', function(req, res, next) {
  ...
  agentObject.businessMessagesAgent.conversationalSettings[formObject.locale] = {
    ...
    conversationStarters: getConversationalStarters(formObject, 'conversationalStarter'),
  };
